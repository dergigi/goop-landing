...
const CAPTIONS: Record<string, string> = {
  goop: 'Welcome screen',
  'welcome-sidebar': 'Inbox and welcome screen',
  'chat-agent': 'Chatting with an agent',
  'chat-profile': 'A chat, profile panel open',
  'split-two': 'Two chats side by side',
  'split-three': 'Three chats side by side',
  'search-chats': 'Search across chats',
  'search-profiles': 'Search profiles',
  profile: 'Profile panel',
  shortcuts: 'Keyboard shortcuts',
  preferences: 'Preferences',
  'welcome-focus': 'Sidebar hidden',
  'chat-agent-light': 'Same chat, light theme',
  'note-to-self-light': 'Note to self',
  'welcome-light': 'Light theme',
  macos: 'macOS',
  windows: 'Windows',
  linux: 'Linux',
};
