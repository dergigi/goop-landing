...
const FALLBACK: Release = {
  version: '2.11.1',
  publishedAt: '2026-09-17T11:41:12Z',
  url: LATEST,
  assets: [
    { name: 'goop-linux-arm64.flatpak', size: 9597816, url: download('goop-linux-arm64.flatpak') },
    { name: 'goop-linux-arm64.snap', size: 15822848, url: download('goop-linux-arm64.snap') },
    { name: 'goop-linux-arm64.tar.gz', size: 26871303, url: download('goop-linux-arm64.tar.gz') },
    { name: 'goop-linux-x64.flatpak', size: 9794168, url: download('goop-linux-x64.flatpak') },
    { name: 'goop-linux-x64.snap', size: 16044032, url: download('goop-linux-x64.snap') },
    { name: 'goop-linux-x64.tar.gz', size: 27898964, url: download('goop-linux-x64.tar.gz') },
    { name: 'goop-macos-arm64.dmg', size: 9340794, url: download('goop-macos-arm64.dmg') },
    { name: 'goop-macos-x64.dmg', size: 10355069, url: download('goop-macos-x64.dmg') },
    { name: 'goop-windows-arm64.exe', size: 7418521, url: download('goop-windows-arm64.exe') },
    { name: 'goop-windows-x64.exe', size: 7876491, url: download('goop-windows-x64.exe') },
